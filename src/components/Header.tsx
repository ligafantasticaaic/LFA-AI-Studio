    ...
    <header className="mb-6 space-y-4">
      ...
      <div className="bg-slate-900/90 backdrop-blur-md border border-slate-800 rounded-2xl p-4 sm:p-5 shadow-xl flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          {/* Logo Oficial LFA respetado al 100% en sus dimensiones naturales sin deformación */}
          <div className="h-14 sm:h-16 max-w-[140px] flex items-center justify-center shrink-0">
            <img 
              src={logoSrc} 
              alt="Logo Liga Fantástica" 
              className="max-h-14 sm:max-h-16 w-auto max-w-[140px] object-contain drop-shadow-md hover:scale-105 transition-transform"
